...
class SvgMathSpace {
    ...
    drawVector(origin, vector, showLength) {
        ...
        if (showLength) {
            ...
            curlyBracesElement.setAttribute("transform", "scale(" +
                vector.length() / 10 +
                ") rotate(" +
                rotationAngle +
                ")");
